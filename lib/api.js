...
export function getCoaches() {
 const coaches = [
  ...
  },
  {
   ...
   company: {
    name: "Adobe",
    url: "https://bio.site/akshayram",
   },
   year: 2025,
   featuredImage: {
    node: {
     sourceUrl: "/images/coaches/akshay-ram.jpg",
     altText: "Akshay Ram",
     mediaDetails: {
      width: 300,
      height: 300,
  ...
  },
  {
   ...
   company: {
    name: "Zappos",
    url: "http://jordanschnitzerdesigns.com",
   },
   year: 2025,
   featuredImage: {
    node: {
     sourceUrl: "/images/coaches/jordan-schnitzer.jpg",
     altText: "Jordan Schnitzer",
     mediaDetails: {
      width: 300,
      height: 300,
     },
  ...
  },
  {
   ...
   company: {
    name: "Sirius XM",
    url: "https://www.nathalyflores.com",
   },
   year: 2025,
   featuredImage: {
    node: {
     sourceUrl: "/images/coaches/nathaly-flores.jpg",
     altText: "Nathaly Flores",
     mediaDetails: {
      width: 300,
      height: 300,
     },
  ...
  },
  {
   ...
   company: {
    ...
    url: "https://jacquelineesimpson.com",
   },
   year: 2025,
   featuredImage: {
    node: {
     sourceUrl: "/images/coaches/jacqueline-simpson.jpg",
     altText: "Jacqueline",
     mediaDetails: {
      width: 300,
      height: 300,
  ...
  },
  {
   ...
   company: {
    name: "Fast Company",
    url: "http://www.mikeschnaidt.com",
   },
   year: 2025,
   featuredImage: {
    node: {
     sourceUrl: "/images/coaches/mike-schnaidt.jpg",
     altText: "Mike Schnaidt",
     mediaDetails: {
      width: 300,
      height: 300,
     },
  ...
  },
  {
   ...
   company: {
    name: "Mariola",
    url: "http://www.mariola.media",
   },
   year: 2025,
   featuredImage: {
    node: {
     sourceUrl: "/images/coaches/jeremy-walker.jpg",
     altText: "Jeremy Walker",
     mediaDetails: {
      width: 300,
      height: 300,
     },
  ...
  },
  {
   ...
   company: {
    name: "Disney+",
    url: "http://libbystankaitis.com",
   },
   year: 2025,
   featuredImage: {
    node: {
     sourceUrl: "/images/coaches/libby-stankaitis.jpg",
     altText: "Libby Stankaitis",
     mediaDetails: {
      width: 300,
      height: 300,
     },
  ...
  },
  {
   ...
   company: {
    name: "Workflow Design Studio",
    url: "http://joshklenert.com",
   },
   year: 2025,
   featuredImage: {
    node: {
     sourceUrl: "/images/coaches/josh-klenert.jpg",
     altText: "Josh Klenert",
     mediaDetails: {
      width: 300,
      height: 300,
     },
  ...
  },
  {
   ...
   company: {
    name: "NBCUniversal",
    url: "https://www.manto.media",
   },
   year: 2025,
   featuredImage: {
    node: {
     sourceUrl: "/images/coaches/marina-antonowicz.jpg",
     altText: "Marina Antonowicz",
     mediaDetails: {
      width: 300,
      height: 300,
     },
...
export function getSponsors() {
 const sponsorsByYear = {
  ...
  2025: [
   ...
   },
   {
    ...
    featuredImage: {
     node: {
      sourceUrl: "/sponsors/baghdad-restaurant-syracuse.png",
      altText: "Baghdad Restaurant",
      mediaDetails: {
       width: 1500,
       height: 871,
      },
   ...
   },
   {
    ...
    featuredImage: {
     node: {
      sourceUrl: "/sponsors/newhouse-school-logo--secondary.svg",
      altText: "Baghdad Restaurant",
      mediaDetails: {
       width: 1500,
       height: 871,
   ...
   },
   {
    ...
    featuredImage: {
     node: {
      sourceUrl: "/sponsors/appethaizing-syracuse.jpg",
      altText: "appeThaizing",
      mediaDetails: {
       width: 347,
       height: 200,
      },
   ...
   },
   {
    ...
    featuredImage: {
     node: {
      sourceUrl: "/sponsors/collegetown-bagels-syracuse.png",
      altText: "appeThaizing",
      mediaDetails: {
       width: 360,
       height: 360,
   ...
   },
   {
    ...
    featuredImage: {
     node: {
      sourceUrl: "/sponsors/ansun-graphics-syracuse.jpg",
      altText: "GD USA",
      mediaDetails: {
       width: 225,
       height: 225,
 ...
 return sponsorsByYear;
}
// Function to get sponsors by year
export function getSponsorsByYear(year) {
 const sponsorsByYear = getSponsors();
 return sponsorsByYear[year] || []; // Return an empty array if no sponsors exist for the given year
}
...
export function getDays() {
 const days = [
  ...
  //    slug: "wednesday",
  //    time: {
  //     start: "2025-01-22T00:00-0500",
  //     end: "2025-01-22T23:59:59-0500",
  //    },
  //   },
  {
   name: "Thursday",
   slug: "thursday",
   time: {
    start: "2025-02-06T00:00-0500",
    end: "2025-02-06T23:59:59-0500",
   },
  },
  {
   name: "Friday",
   slug: "friday",
   time: {
    start: "2025-02-07T00:00-0500",
    end: "2025-02-07T23:59:59-0500",
   },
  },
  {
   name: "Saturday",
   slug: "saturday",
   time: {
    start: "2025-02-08T00:00-0500",
    end: "2025-02-08T23:59:59-0500",
   },
  },
 ];
 return days;
...
export function getWorkshopDatesByYear(year) {
 const workshopDates = {
  2023: "March 2-4, 2023",
  2024: "Feb. 22-24, 2024",
  2025: "Feb. 6-8, 2025",
 ...
 return workshopDates[year] || "Dates to be announced";
}
export function getRoomBySlug(slug) {
 const rooms = [
  ...
  {
   name: "Legal Sea Foods Dining Room",
...
export function getEvents() {
 const events = [
  ...
  },
  {
   ...
   time: {
    start: "2025-02-06T09:30-0500",
    end: "2025-02-06T12:00-0500",
   },
   location: "tba",
  },
  {
   ...
   slug: "workshop-kick-off",
   time: {
    start: "2025-02-06T18:45-0500",
    end: "2025-02-06T19:00-0500",
   },
   location: "nh1-101-102",
  },
  {
   title: "Client Intro + Coaches Intros",
   slug: "client-coaches-intros",
   time: {
    start: "2025-02-06T19:00-0500",
    end: "2025-02-06T20:00-0500",
   },
   location: "nh1-101-102",
  },
  {
  ...
  //    slug: "client-q-and-a",
  //    time: {
  //     start: "2025-01-22T11:00-0500",
  //     end: "2025-01-22T12:00-0500",
  //    },
  //    location: "nh1-212-zoom",
  //   },
  {
   title: "Group Meeting",
   slug: "group-meeting",
   time: {
    start: "2025-02-07T10:00-0500",
    end: "2025-02-07T10:30-0500",
   },
   location: "nh1-101",
  },
  {
   ...
   slug: "client-presentation-and-critique",
   time: {
    start: "2025-02-07T10:30-0500",
    end: "2025-02-07T11:00-0500",
   },
   location: "nh3-141",
  },
  {
   ...
   slug: "group-photo",
   time: {
    start: "2025-02-07T11:00-0500",
    end: "2025-02-07T11:15-0500",
   },
   location: "nh1-lobby",
  },
  {
   ...
   slug: "team-meetings",
   time: {
    start: "2025-02-07T11:15-0500",
    end: "2025-02-07T12:00-0500",
   },
   location: "nh1-101-102",
  },
  {
   ...
   slug: "lunch",
   time: {
    start: "2025-02-07T12:00-0500",
    end: "2025-02-07T13:00-0500",
   },
   location: "legal-sea-foods",
  },
  {
   ...
   slug: "work-time",
   time: {
    start: "2025-02-07T13:00-0500",
    end: "2025-02-07T17:00-0500",
   },
   location: "nh1-101-102",
  },
  {
   ...
   slug: "team-meetings-work-time",
   time: {
    start: "2025-02-07T17:00-0500",
    end: "2025-02-07T18:00-0500",
   },
   location: "nh1-101-102",
  },
  {
   ...
   slug: "dinner",
   time: {
    start: "2025-02-07T18:00-0500",
    end: "2025-02-07T19:00-0500",
   },
   location: "legal-sea-foods",
  },
  {
   title: "Group Presentations and Critique",
   slug: "group-presentations-and-critique",
   time: {
    start: "2025-02-07T19:00-0500",
    end: "2025-02-07T20:00-0500",
   },
   location: "nh3-141",
  },
  {
   title: "Team Meetings + Homework Assignments",
   slug: "team-meetings-homework-assignments",
   time: {
    start: "2025-02-07T20:30-0500",
    end: "2025-02-07T21:30-0500",
   },
   location: "nh1-101-102",
  },
  {
  ...
  },
  {
   ...
   slug: "full-group-meeting",
   time: {
    start: "2025-02-08T10:00-0500",
    end: "2025-02-08T10:30-0500",
   },
   location: "nh1-101",
  },
  {
  ...
  },
  {
   ...
   slug: "lunch",
   time: {
    start: "2025-02-08T12:00-0500",
    end: "2025-02-08T13:00-0500",
   },
   location: "legal-sea-foods",
  },
  {
   ...
   slug: "work-with-your-teams",
   time: {
    start: "2025-02-08T13:00-0500",
    end: "2025-02-08T18:00-0500",
   },
   location: "nh1-101-102",
  },
  {
  ...
  },
  {
   ...
   slug: "final-presentation",
   time: {
    start: "2025-02-08T19:00-0500",
    end: "2025-02-08T20:00-0500",
   },
   location: "nh3-141",
  },
  {
   ...
   slug: "dessert-and-workshop-close",
   time: {
    start: "2025-02-08T20:00-0500",
    end: "2025-02-08T20:30-0500",
   },
   location: "legal-sea-foods",
  },
 ];
...
export function getEventsByDay(start, end) {
 ...
 return events.filter(
  (event) => event.time.start >= start && event.time.start <= end
 );
}
